...
public class UserService {
    ...
    public void sendsms(String mobile) {
        //1）获取用户输入的手机号码
        //2）在系统生成随机6位数字验证码（commons-lang   RandomStringUtils）
        ...
        map.put("code",code);
        System.out.println("发送redis和rabbitMQ="+map);
    ...
    public void add(User user, String code) {
        //提取系统保存的验证码
        String syscode = (String) redisTemplate.opsForValue().get("sendsms_" + user.getMobile());
