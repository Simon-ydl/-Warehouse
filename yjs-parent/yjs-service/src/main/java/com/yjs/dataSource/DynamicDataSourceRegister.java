...
//	}
	...
	private Map<String, Map<String, Object>> getCustomDataSourceInfo() {
		...
		String sql = "select CODE,NAME,type,DC,URL,username,password from t_sys_database";
		JdbcTemplate jdbcTemplate = new JdbcTemplate(defaultDataSource);
		List<Database> infos = jdbcTemplate.query(sql, new RowMapper<Database>() {
			@Override
...
//		return new DataSourceTransactionManager(customDataSources.get("nxsign_cert"));
//	}
